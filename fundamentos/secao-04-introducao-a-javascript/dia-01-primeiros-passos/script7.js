...
// Programa 15/15 - Utilize if/else para fazer um programa que, dado um salário bruto, calcule o líquido a ser recebido.
...
if (salarioBruto <= 1556.94 ) {
  ...
  salarioDescontoInss = salarioBruto - descontoInss;
...
if (salarioDescontoInss <= 1903.98) {
  ...
  descontoIr = salarioDescontoInss * 15/100 - 354.80;
  console.log(descontoIr);
} else if (salarioDescontoInss >= 3751.06 && salarioDescontoInss <= 4664.68) {
  descontoIr = salarioDescontoInss * 22/100 - 636.13;
  console.log(descontoIr);
} else if (salarioDescontoInss > 4664.68) {
  descontoIr = salarioDescontoInss * 27.5/100 - 869.36;
  console.log(descontoIr);
}
let salarioFinal = salarioDescontoInss - descontoIr
