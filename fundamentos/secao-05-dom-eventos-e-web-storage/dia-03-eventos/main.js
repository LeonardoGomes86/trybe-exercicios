...
//  R - a classe tech colocada nesta caixa está com o atributo transform: translateY(-20px), alterando sua altura.
...
function clicadoTech1 () {

  if(li1.className != 'tech') {
    li1.className = 'tech';
    li2.className = '';
    li3.className = '';
  } else if (li1.className == 'tech') {
    li1.className = '';
    li2.className = '';
    li3.className = '';
  }
...
function clicadoTech2 () {
  if(li2.className != 'tech') {
    li1.className = '';
    li2.className = 'tech';
    li3.className = '';
  } else if (li2.className == 'tech') {
    li1.className = '';
    li2.className = '';
    li3.className = '';
  }
...
function clicadoTech3 () {
  if(li3.className != 'tech') {
    li1.className = '';
    li2.className = '';
    li3.className = 'tech';
  } else if (li3.className == 'tech') {
    li1.className = '';
    li2.className = '';
    li3.className = '';
  }
...
li1.addEventListener('click', clicadoTech1);
li2.addEventListener('click', clicadoTech2);
li3.addEventListener('click', clicadoTech3);
// RESOLUÇÃO GUILHERME usando apenas uma função.
//
// let liList = document.getElementsByTagName('li');
// for(let index of liList) {
//   index.addEventListener('click', transformItem);
// }
// function transformItem(li){
